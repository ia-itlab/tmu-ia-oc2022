...
(function() {
	...
	// "On Visible" animations.
		onvisible.add('h1.style2, h2.style2, h3.style2, p.style2', { style: 'fade-right', speed: 1000, intensity: 1, delay: 0, replay: false });
		onvisible.add('h1.style3, h2.style3, h3.style3, p.style3', { style: 'fade-left', speed: 1000, intensity: 0, delay: 0, replay: false });
		onvisible.add('.icons.style1', { style: 'tilt-left', speed: 1000, intensity: 2, delay: 0, stagger: 125, replay: false });
		onvisible.add('.buttons.style1', { style: 'fade-up', speed: 1000, intensity: 1, delay: 0, replay: false });
		onvisible.add('h1.style1, h2.style1, h3.style1, p.style1', { style: 'fade-left', speed: 1000, intensity: 1, delay: 0, replay: false });
		onvisible.add('.image.style1', { style: 'fade-in', speed: 1000, intensity: 0, delay: 0, replay: false });
